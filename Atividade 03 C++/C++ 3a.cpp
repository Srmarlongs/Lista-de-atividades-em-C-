...
int main() {
    ...
    if (numero1 > numero2) {
        // Exibe uma mensagem se o primeiro número for maior que o segundo
        cout << "O primeiro número (" << numero1 << ") é maior que o segundo número (" << numero2 << ")." << endl;
    } else {
        // Exibe uma mensagem se o primeiro número não for maior que o segundo
        cout << "O primeiro número (" << numero1 << ") não é maior que o segundo número (" << numero2 << ")." << endl;
    }
