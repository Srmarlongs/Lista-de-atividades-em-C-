...
int main() {
    double num1, num2; // Declaração de duas variáveis do tipo double para armazenar os números reais
    ...
    // Verifica se o primeiro número é menor ou igual ao segundo número
    if (num1 <= num2) {
        cout << "O primeiro número (" << num1 << ") é menor ou igual ao segundo número (" << num2 << ")." << endl; // Se a condição for verdadeira
    } else {
        cout << "O primeiro número (" << num1 << ") é maior que o segundo número (" << num2 << ")." << endl; // Se a condição não for verdadeira
    }
